          ...
          <Container>
            <HeaderContainer>
              <UserInfoContainer>
                {user.avatar && (
                  <UserAvatar>
                    <img src={user.avatar} alt="User" width="32" height="32" />
                  </UserAvatar>
                )}
